...
function Goodbye(){
	...
	if [[ "$language" == "e" ]];then
		...
		echo -e ""
		echo -e "${Font_SkyBlue}【推荐机场】${Font_Suffix}"
		echo -e "================================================"
		echo -e "${Font_Yellow}精品线路加速器 三网回程cmi及CN2 GIA线路 端口带宽1Gbps以及上${Font_Suffix}"
		echo -e "${Font_Red}传送门：${Font_Suffix}https://freefly.video"
		echo -e "================================================"
	fi	
}
